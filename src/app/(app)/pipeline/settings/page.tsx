...
// Pipeline Settings — the one page in the app that changes how the chain runs
// rather than what is in it.
//
// It sits under Pipeline because that is what it decides the entrance to: the
// five steps are what Discovery spends money on, and the threshold is the bar
// a candidate has to clear to arrive in the pipeline at all. Everything on it
// was a constant in the source until this page existed.
